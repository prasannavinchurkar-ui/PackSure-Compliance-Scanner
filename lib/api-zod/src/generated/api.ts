...
export const ListScansResponseItem = zod.object({
  ...
  "mrp": zod.string().nullable(),
  "packedDate": zod.string().nullable(),
  "consumerCare": zod.string().nullable(),
  "countryOfOrigin": zod.string().nullable(),
  "barcodeValue": zod.string().nullable(),
  "barcodeFormat": zod.string().nullable(),
  "barcodeSource": zod.string().nullable(),
  "category": zod.string(),
...
export const CreateScanBody = zod.object({
  ...
  "packedDate": zod.string().nullish(),
  "consumerCare": zod.string().nullish(),
  "countryOfOrigin": zod.string().nullish(),
  "barcodeValue": zod.string().nullish(),
  "barcodeFormat": zod.string().nullish(),
  "barcodeSource": zod.string().nullish(),
